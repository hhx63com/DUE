...
4. **切换到 Sheep-eat-grass 分支**：
   ```bash
   cd DUE
   git checkout Sheep-eat-grass
   ```
...
4. **脚本错误**：如果遇到脚本错误，请检查 Unity 版本是否符合要求，或者尝试重新导入项目

5. **音频文件**：项目包含音频文件，确保你的系统音量已开启以获得完整的游戏体验
